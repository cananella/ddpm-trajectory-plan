...
def generate_launch_description():
    ...
    control_node = Node(
        ...
        executable="m0609_trajectory_controller_server",
        name="m0609_trajectory_controller_server",
        output="screen"
    )
    ...
    api_drfl_file = Node(
        package="m0609_controller",
        executable="m0609_trajectory_controller_client",
        name="m0609_trajectory_controller_client",
    )
